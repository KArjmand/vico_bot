...
The skills system allows you to extend vicobot with custom knowledge, workflows, and domain expertise.
...
Vicobot provides built-in tools for managing skills:
...
3. **Reference tools**: Mention which vicobot tools are relevant
...
```bash
# List skills
ls ~/.vicobot/workspace/skills/

# Create skill
mkdir -p ~/.vicobot/workspace/skills/my-skill
cat > ~/.vicobot/workspace/skills/my-skill/SKILL.md <<EOF
---
name: my-skill
...
# Delete skill
rm -rf ~/.vicobot/workspace/skills/my-skill
```
